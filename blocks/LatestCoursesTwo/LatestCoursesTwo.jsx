...
import styles from './LatestCoursesTwo.module.scss';

const LatestCoursesTwo = ({ jobCodes = [] }) => {
    const courses = [
        {
            id: 1,
            code: 'it-networking',
        ...
        },
        {
            ...
            description:
                'Turn your creativity into a career. Learn illustration, garment construction, Aari embroidery, CAD pattern making, and boutique management through guided studio sessions that bring your designs to life.',
            level: 'All Levels',
        ...
        },
        {
            ...
            description:
                'Discover how to plan, draft, and visualise spaces with AutoCAD, 3ds Max, Revit, and lighting techniques. Work on live interior projects that build confidence to design real homes and commercial spaces.',
            level: 'All Levels',
        ...
        },
        {
            ...
            description:
                'Understand how data drives decisions. Learn Python, Power BI, machine learning models, and generative AI tools to analyse data and automate insights — skills valued across tech and business industries.',
            level: 'All Levels',
    ...
    const filteredCourses = courses.filter((course) => jobCodes.includes(course.code));
            ...
            <div className={styles.container}>
                ...
                <div className={styles.coursesGrid}>
                    {filteredCourses.length > 0 ? (
                        ...
                        <p className={styles.noCoursesText}>No related courses found.</p>
                    )}
                </div>
            </div>
        </section>
...
export default LatestCoursesTwo;
